...
def Autoencoder(input_shape, train, val, early_stopping_patience=10):
	...
	e = Conv2D(filters=128, kernel_size=3, activation='tanh', strides=1, padding='same')(model_input)
	e = Conv2D(filters=256, kernel_size=3, activation='tanh', strides=1, padding='same')(e)
	e = Conv2D(filters=512, kernel_size=3, activation='tanh', strides=1, padding='same')(e)
	e = Conv2D(filters=1024, kernel_size=2, activation='tanh', strides=2, padding='same')(e)
	...
	d = Conv2DTranspose(filters=1024, kernel_size=2, activation='tanh', strides=2, padding='same')(d)
	d = Conv2DTranspose(filters=512, kernel_size=3, activation='tanh', strides=1, padding='same')(d)
	d = Conv2DTranspose(filters=256, kernel_size=3, activation='tanh', strides=1, padding='same')(d)
	d = Conv2DTranspose(filters=128, kernel_size=3, activation='tanh', strides=1, padding='same')(d)
	...
	opt = tf.keras.optimizers.Adam(learning_rate=1.2364130448970488e-7)		# learning rate that actually started producing good results
...
def main():
	...
	encoder.save('models/encoder_v4.h5')
